...
* Each team takes turn to answer the question ( 12 questions in total)
  - Starting with Row arto 
* Read the entire question and answer in 30 seconds
* Correct answer: 2 points.
* Incorrect answer: no points
{{< countdown "0:30" play_sound=true warn_when=10 bottom="0" left="0" >}}


## 1) What is the primary purpose of the MUTCD?{.quiz-question}
...
## 2) Which MUTCD Part contains pavement-marking provisions?{.quiz-question}
...
## 3) In the MUTCD, what does the word “shall” mean?{.quiz-question}
- [Required]{.correct}
- Recommended
- Optional
- Informational only
...
## 4) Which MUTCD Part should an engineer consult first for a work-zone traffic-control question?{.quiz-question}
- Part 2 — Signs
- Part 3 — Markings
- Part 4 — Signals
...
## 5) What type of sign is this?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
...
## 6) What is the primary purpose of this sign?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
...
## 7) What is the main purpose of this sign?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
...
## 8) What does white dashed line marking generally separate?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
...
## 9) What does this marking generally communicate?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
...
## 10) What is the primary purpose of the stop bar?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
...
## 11) What does this (signal on the right) indication require a driver to do?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
![](images/chap4/ch4_greenLTsignal.png){width="600" height="300" fig-align="center"}
...
## 12) What does green arrow signal indication communicate?{{< countdown "0:30" play_sound=true warn_when=10 top="10" right="0" >}}{.quiz-question}
![](images/chap4/ch4_greenLTsignal.png){width="600" height="300" fig-align="center"}
